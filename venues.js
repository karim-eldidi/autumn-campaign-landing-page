...
const USC_PLANS = [
  {
    id: 'essential',
    name: 'Essential',
    headline: 'Move twice a week',
    emoji: '📅',
    tierInfo: '8 check-ins / month · 5,600+ venues',
    monthlyPrice: 45,
    annualPrice: 39,
    biennialPrice: 34,
    checkIns: '8 check-ins / month',
  ...
  },
  {
    ...
    emoji: '🪷',
    tierInfo: 'Daily + 4 Plus check-ins · includes 1 massage',
    monthlyPrice: 115,
    annualPrice: 104,
    biennialPrice: 99,
